						...
						if (!column[o].hide || column[o].hide == undefined) {
							...
							if (l_tree.tree) {
								...
								if(CommnUtil.in_array(lt,clm)){
									...
									divtree.setAttribute("style", "padding-top:11px;margin-left:5px;text-align:" + column[o].align + ";");
									var img = document.createElement('img');
									if(l_tree.hide||l_tree.hide!=undefined)
										img.src=ctx+"/static/images/tree/nolines_plus.gif";
									else
										img.src=ctx+"/static/images/tree/nolines_minus.gif";
						...
						if (!column[o].hide || column[o].hide == undefined) {
							...
							if (l_tree.tree) {
								...
								if(CommnUtil.in_array(lt,column[o].colkey)){
									var divtree = document.createElement("div");
									divtree.className = "ly_tree";
									divtree.setAttribute("style", "padding-top:11px;margin-left:5px;text-align:" + column[o].align + ";margin-left: " + nb + "px;");
									if(tte){
										var img = document.createElement('img');
										img.src=ctx+"/static/images/tree/nolines_minus.gif";
										img.onclick=datatree.bind();
