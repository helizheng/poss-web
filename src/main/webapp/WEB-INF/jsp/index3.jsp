...
<c:set var="ctx" value="${pageContext.request.contextPath}" />
    ...
    <!-- jQuery -->
    <script src="${ctx}/static/bootstrap3/js/jquery.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="${ctx}/static/bootstrap3/js/bootstrap.js"></script>
    <!-- Bootstrap Core CSS -->
    <link href="${ctx}/static/bootstrap3/css/bootstrap.css" rel="stylesheet">
